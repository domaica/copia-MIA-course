...
console.log('MAPARROW1: ', mapArrow1);
...
console.log('MAPRETURN 2 MORE THAN 1 PARAMETER NEED PARENTHESIS: ', mapReturn2);

// We can also drop the curly braces here
var mapReturn2_dropcurly = theStagesOfJS.map((item, index) => `Stage ${index}: ${item}`);
console.log('MAPRETURN 2 DROP CURLY: ', mapReturn2_dropcurly);
